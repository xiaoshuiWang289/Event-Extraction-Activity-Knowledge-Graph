...
--trigger_ckpt_dir='./out/final/trigger/roberta_wwm_pgd_enhanced/checkpoint-100000' \
--role1_ckpt_dir='./out/final/role1/roberta_wwm_distance_pgd_enhanced/checkpoint-1392' \
--role2_ckpt_dir='./out/final/role2/roberta_wwm_distance_pgd_enhanced/checkpoint-1092' \
